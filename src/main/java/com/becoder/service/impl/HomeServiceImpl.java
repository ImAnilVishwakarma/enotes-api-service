...
public class HomeServiceImpl implements HomeService{
	...
	@Override
	public Boolean verifyAccount(Integer userld, String verificationCode) throws Exception {

		User user = userRepo.findById(userld).orElseThrow(() -> new ResourceNotFoundException("invalid user"));
